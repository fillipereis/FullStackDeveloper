...
if ('D:\Dev\Projetos\Frameworks\backend\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\Dev\Projetos\Frameworks\backend\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
